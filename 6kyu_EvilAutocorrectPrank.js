...
// sleeping, you take his phone and change the autocorrect options so that every time 
...
// of "you" or "u" (not case sensitive) with "your sister" (always lower case).

// Return the resulting string.

// Here's the slightly tricky part: These are text messages, so there are different 
// forms of "you" and "u".
...
function autocorrect(input) {
    return input.replace(/\b(u|you+)\b/gi, "your sister");
}