...
// But, of course, only Santa himself is allowed to use this wonderful 
// transportation. And in order to make sure, that only he can board the sleigh, 
// there's an authentication mechanism.

// Your task is to implement the authenticate() method of the sleigh, which takes 
// the name of the person, who wants to board the sleigh and a secret password. 
...
// 	and special characters :D), the return value must be true. Otherwise it 
// should return false.
