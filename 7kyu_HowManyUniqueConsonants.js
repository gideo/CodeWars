...
// Complete the function that counts the number of unique consonants in a 
// string (made up of printable ascii characters).
...
// differing cases. For example, "Dad" passed into the function should return 1 as "d" and "D" are duplicates.
...
let countConsonants = str => new Set(str.toLowerCase().replace(/[aeiou]|[^a-z]/g, '')).size;