// 7kyu - Codewars Leadboard Climber
...
let leaderB = (u, s, ys) => (d=> d < 0 ? "Winning!" : d === 0 ? "Only need one!" : `To beat ${u}'s score, I must complete ${Math.floor(d/3)} Beta kata and ${d%3} 8kyu kata.${d>2996 ? " Dammit!" : ""}`)(s-ys);