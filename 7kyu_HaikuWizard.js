...
// A haiku is a traditional form of Japanese poetry, they normally have 3 lines with 
// 5, 7 and 5 syllables respectively. For example:
...
// You only have to translate the haiku from numbers to words, no need to start looking 
// frantically for creative inspiration. Let me explain:
...
// For each number, the first digit tells you the number of syllables of the word, 
// the second digit tells you which member of the relevant subarray it is.

// For example:

// 52: This means that the first line is made up of one word with 5 syllables, at 
// index 2 in words[4].

// [17, 23, 39, 18]: This means that the second line is made up of 4 words. The first 
// has 1 syllable and is at index 7 in words[0]. The second has 2 syllables and is at 
// index3 in words[1]. And so on...

// All you have to do is complete the function haikuWizard() so that it translates the 
// given array back into the beautiful haiku it came from :) You should return a string, 
// which on using console.log should display in the appropriate haiku format:
