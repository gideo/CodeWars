...
// third provided paramater, which will also be an interger. You are additionally 
...
// Since the 3rd word is 'string'(starting from 0 remember) and the third paramater 
// indicates that it should be repeated 5 times.

// Simple. Good luck.

let modifyMultiply = (str, loc, num) => Array(num).fill(str.split(' ')[loc]).join('-');