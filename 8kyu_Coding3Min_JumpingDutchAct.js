...
// floor more than 6, the person will often die in an instant; When the floor is less 
// than or equal to 6, the person will not immediately die, he would scream. 
// (without proof)
...
function sc(floor) { 
  return (floor > 1) ? ("Aa~" + " Aa~".repeat(floor-2) + " Pa!" + (floor<7 ? " Aa!":"")) :"";
}