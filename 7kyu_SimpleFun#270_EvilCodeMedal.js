...
// Task
// EvilCode is a game similar to Codewars. You have to solve programming 
// tasks as quickly as possible. However, unlike Codewars, EvilCode 
...
// corresponding to the medal. You can be awarded "Gold", "Silver" or 
// "Bronze" medal, or "None" medal at all. Only one medal (the best 
// 	achieved) is awarded.

// You are given the time achieved for the task and the time corresponding 
// to each medal. Your task is to return the awarded medal.
...
// The medal awarded, one of for options: "Gold", "Silver", "Bronze" 
// or "None".
