...
// Going to one direction and coming back the opposite direction is a needless effort. Since this 
// is the wild west, with dreadfull weather and not much water, it's important to save yourself 
...
// [North, South, South, East, West, North, West]
// You can immediatly see that going "NORTH" and then "SOUTH" is not reasonable, better stay to 
...
// The Haskell version takes a list of directions with data Direction = North | East | West | 
// South. The Clojure version returns nil when the path is reduced to nothing. The Rust version 
// takes a slice of enum Direction {NORTH, SOUTH, EAST, WEST}.
...
// other and can't become such. Hence the result path is itself : ["NORTH", "WEST", "SOUTH", 
// "EAST"].
