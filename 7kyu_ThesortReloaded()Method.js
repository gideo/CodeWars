...
Array.prototype.sortReloaded = function sortReloaded(dir = 'asc') {
  let sortNumbers = (a, b) => a - b;
  if(dir === 'asc') return [].concat(this).sort(sortNumbers);
  if(dir === 'desc') return [].concat(this).sort(sortNumbers).reverse();
  return false;
}