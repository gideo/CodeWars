...
// When no more interesting kata can be resolved, I just choose to create the new 
// kata, to solve their own, to enjoy the process --myjinxin2015 said
// Description:

// Given an array arr that contains some integers(positive, negative or 0), and a 
// range list such as [[start1,end1],[start2,end2],...], start and end are the index 
// of arr and start always less than end. Your task is to calculate the sum value 
// of each range, and return the maximum sum value.
...
// This is a simple version, if you want some challenge, 
