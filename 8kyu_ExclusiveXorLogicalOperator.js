...
// 	of this Kata). The exclusive or evaluates two booleans. It then 
// returns true if exactly one of the two expressions are true, false 
...
// 	know how to do it), your task is to define a function xor(a, b) 
// where a and b are the two expressions to be evaluated. Your xor function 
// should have the behaviour described above, returning true if exactly one 
