...
// You drop a ball from a given height. After each bounce, the ball 
// returns to some fixed proportion of its previous height. If the ball 
// bounces to height 1 or less, we consider it to have stopped bouncing. 
...
let bouncingBall = (init, prop) => Math.ceil(Math.log10(init)/Math.log10(1/prop));