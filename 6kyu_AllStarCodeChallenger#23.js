// 6 kyu - All STar Code Challenger #23
...
// There is a certain multiplayer game where players are assessed at the end of the 
// game for merit. Players are ranked according to an internal scoring system that 
// players don't see.
...
// returns an array of player names, in order of descending score (highest score is 
// index 0, 2nd highest is index 1, etc.).
...
// Environmental kills are worth 500 points (These are counted separately from normal 
// kills)
// For each of the above statistic, a Player object contains a respective "key:value" 
// pairing. All values except the 'name' are integers.
...
// Note:
// Assume the input array will ALWAYS have a properly constructed Player object (no 
...
// For simplicity, for a kill streak of 0 the kill streak calculation will yield 1 
// (or 20) points
