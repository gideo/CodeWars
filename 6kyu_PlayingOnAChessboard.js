...
// get "head" wins and the other gives him, in dollars, the sum of the numbers on the 
// chessboard. We play for fun, the dollars come from a monopoly game!

// How much can I (or my friend) win or loses for each game if the chessboard has n 
// rows and n columns? Add all of the fractional values on an n by n sized board and 
...
// 'game' returns either a "Left Integer" if denominator is 1 otherwise "Right 
// (Integer, Integer)"
