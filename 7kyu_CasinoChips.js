...
// You will be given an array representing the number of chips of each color and your task is to return the number of days you can pick the chips. Each day you need to take exactly two chips.
