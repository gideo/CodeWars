// 7kyu - Sort Out the Men from Boys
...
// Since , Men are stronger than Boys , Then Even numbers in ascending order While odds 
// in descending .
...
// 2- menFromBoys ({-94, -99 , -100 , -99 , -96 , -99 }) ==> 
// return ({-100 , -96 , -94 , -99})
// Explanation:
// Since , { -100, -96 , -94 } is the even numbers here , So it came first in 
// ascending order , then the odds in descending order { -99 }

// Since , (Duplications are not included when separating) , then you can see only 
// one (-99) was appeared in the final array/list .

// 3- menFromBoys ({49 , 818 , -282 , 900 , 928 , 281 , -282 , -1 }) ==> return 
...
function menFromBoys(arr){
  ...
  let odd = arr.filter(a => a % 2).sort((a, b) => b - a),
      even = arr.filter(a => a % 2 === 0).sort((a, b) => a - b);
  return [...even, ...odd];
}