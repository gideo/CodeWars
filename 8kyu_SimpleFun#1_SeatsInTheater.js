...
// awfully dull. It's so bad you want to sneak out, which is quite simple, 
...
// left. To gain some courage, you decide to calculate the number of such 
// people and see if you can possibly make it to the exit without 
// disturbing too many people.

// Given the total number of rows and columns in the theater (nRows 
// 	and nCols, respectively), and the row and column you're sitting 
// in, return the number of people who sit strictly behind you and in 
