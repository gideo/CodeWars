...
// It is necessary to write a function that takes a coordinate on the x-axis and 
// y-axis and returns a list of all the neighboring points. Points inside list don't 
// have to been sorted (any order is valid).
...
let cartesianNeighbor = function(x,y) {
